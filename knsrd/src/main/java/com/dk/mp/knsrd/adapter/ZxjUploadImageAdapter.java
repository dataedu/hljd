...
import com.dk.mp.knsrd.pjpy.PjpyMainActivity;
import com.dk.mp.knsrd.zxj.ZxjMainActivity;
 ...
 */
public class ZxjUploadImageAdapter extends RecyclerView.Adapter<ZxjUploadImageAdapter.MyViewHolder>{

    private ZxjMainActivity activity;
    private Context mContext;
    private List<String> data;
    private LayoutInflater inflater;

    public ZxjUploadImageAdapter(Context context, ZxjMainActivity activity, List<String> basicList) {
    ...
    @Override
    public ZxjUploadImageAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = inflater.inflate(R.layout.ad_upload_image,parent,false);
        return new MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(ZxjUploadImageAdapter.MyViewHolder holder, int position) {
