...
public class GzbxTabActivity extends MyActivity{
...
//                    showMessage(getString(R.string.data_error));
    ...
    private void initViewPager(){
        ...
        fragments.add(GzbxListActivity.newInstance("wait",0));
        fragments.add(GzbxListActivity.newInstance("processed",0));
