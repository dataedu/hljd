 ...
 */
public class PjpyUploadImageAdapter extends RecyclerView.Adapter<PjpyUploadImageAdapter.MyViewHolder>{

    private PjpyMainActivity activity;
    private Context mContext;
    private List<String> data;
    private LayoutInflater inflater;

    public PjpyUploadImageAdapter(Context context, PjpyMainActivity activity, List<String> basicList) {
    ...
    @Override
    public PjpyUploadImageAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = inflater.inflate(R.layout.ad_upload_image,parent,false);
        return new MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(PjpyUploadImageAdapter.MyViewHolder holder, int position) {
